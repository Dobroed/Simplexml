                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <select size="1"  name="available[]" id="available">
                                    <?php
                                    $select = $_POST["available"];
                                    switch ($select[0]) {
                                        case "Любое":
                                            echo "<option selected>Любое</option>";
                                            echo "<option>Есть в наличии</option>";
                                            echo "<option>Нет в наличии</option>";
                                            break;
                                        case "Есть в наличии":
                                            echo "<option>Любое</option>";
                                            echo "<option selected>Есть в наличии</option>";
                                            echo "<option>Нет в наличии</option>";
                                            break;
                                        case "Нет в наличии":
                                            echo "<option>Любое</option>";
                                            echo "<option>Есть в наличии</option>";
                                            echo "<option selected>Нет в наличии</option>";
                                            break;
                                        default:
                                            echo "<option selected>Любое</option>";
                                            echo "<option>Есть в наличии</option>";
